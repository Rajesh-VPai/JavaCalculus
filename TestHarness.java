...
//            } 
    ...
    public static void TestCaseDiff105() {
        ...
        Usage.EqnSolArrayMap1[1] = "x^a+x^a+x^a-x^a-25.0^a";
        Usage.EqnSolArrayDiffAlone[1] = "a*x^(a-1.0)+a*x^(a-1.0)+a*x^(a-1.0)-a*x^(a-1.0)-0.0";
        Usage.EqnSolArrayMap2[1] = "";
    ...
    public static void TestCaseDiff80009() {
        ...
        Usage.EqnSolArrayIntegrAlone[1]="ln(xyc)-0.04*xyc";
        Usage.EqnSolArrayMap4[1]="ln(xyc)-0.04*xyc";
        Usage.EqnSolOrder[1] = 1;
