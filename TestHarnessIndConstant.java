...
public class TestHarnessIndConstant {
    ...
    /* **************************************** */
        ...
        Usage.EqnSolArrayMap2[1] = "p*xyc1^8.0+p*36.0*xyc1^5.0+p*xyc1^4.0+p*4.0*xyc1+p*25.0";
        Usage.EqnSolArrayMap3[1]="p/9.0*xyc1^9.0+p*6.0*xyc1^6.0+p/5.0*xyc1^5.0+p*2.0*xyc1^2.0+p*25.0*xyc1+p*50.0";
        Usage.EqnSolArrayIntegrAlone[1]="p/9.0/10.0*xyc1^10.0+p*6.0/7.0*xyc1^7.0+p/5.0/6.0*xyc1^6.0+p*2.0/3.0*xyc1^3.0+p*25.0*xyc1^2.0*1.0/2.0+p*50.0*xyc1";
        ...
        Usage.EqnSolArrayMap1[2] = "p*xyc1^8.0+p*36.0*xyc1^5.0+p*xyc1^4.0+p*4.0*xyc1+p*25.0";
        Usage.EqnSolArrayDiffAlone[2] = "p*8.0*xyc1^7.0+p*36.0*5.0*xyc1^4.0+p*4.0*xyc1^3.0+p*4.0+0.0";
        Usage.EqnSolArrayMap2[2] = "p*8.0*xyc1^7.0+p*180.0*xyc1^4.0+p*4.0*xyc1^3.0+p*4.0";
        ...
        Usage.EqnSolArrayIntegrAlone[2]="p/90.00000000000001/11.0*xyc1^11.0+p*0.8571428571428571/8.0*xyc1^8.0+p/30.0/7.0*xyc1^7.0+p*0.6666666666666666/4.0*xyc1^4.0+p*12.5/3.0*xyc1^3.0+p*50.0*xyc1^2.0*1.0/2.0";
        ...
        Usage.EqnSolArrayMap1[3] = "p*8.0*xyc1^7.0+p*180.0*xyc1^4.0+p*4.0*xyc1^3.0+p*4.0";
        Usage.EqnSolArrayDiffAlone[3] = "p*8.0*7.0*xyc1^6.0+p*180.0*4.0*xyc1^3.0+p*4.0*3.0*xyc1^2.0+0.0";
        Usage.EqnSolArrayMap2[3] = "p*56.0*xyc1^6.0+p*720.0*xyc1^3.0+p*12.0*xyc1^2.0";
        ...
        Usage.EqnSolArrayIntegrAlone[3]="p/990.0000000000002/12.0*xyc1^12.0+p*0.10714285714285714/9.0*xyc1^9.0+p/210.00000000000003/8.0*xyc1^8.0+p*0.16666666666666666/5.0*xyc1^5.0+p*4.166666666666667/4.0*xyc1^4.0+p*25.0*1.0/3.0*xyc1^3.0";
        ...
        Usage.EqnSolArrayMap1[4] = "p*56.0*xyc1^6.0+p*720.0*xyc1^3.0+p*12.0*xyc1^2.0";
        Usage.EqnSolArrayDiffAlone[4] = "p*56.0*6.0*xyc1^5.0+p*720.0*3.0*xyc1^2.0+p*12.0*2.0*xyc1^1.0";
        Usage.EqnSolArrayMap2[4] = "p*336.0*xyc1^5.0+p*2160.0*xyc1^2.0+p*24.0*xyc1";
        ...
        Usage.EqnSolArrayIntegrAlone[4]="p/11880.000000000004/13.0*xyc1^13.0+p*0.011904761904761904/10.0*xyc1^10.0+p/1680.0000000000002/9.0*xyc1^9.0+p*0.03333333333333333/6.0*xyc1^6.0+p*1.0416666666666667/5.0*xyc1^5.0+p*8.333333333333334*1.0/4.0*xyc1^4.0";
        ...
        Usage.EqnSolArrayIntegrAlone[1]="a/9.0*x^9.0+a/6.0*x^6.0+a/5.0*x^5.0-a*2.0*x^2.0*1.0/2.0-50.0*x";
       ...
       public static void TestCaseDiff50009() {
        ...
        Usage.EqnSolArrayMap3[1] = "a*b*c*x^8.0+a*b*c*x^5.0+a*b*c*x^4.0-a*b*c*2.0*x-a*b*c*50.0";
        Usage.EqnSolArrayIntegrAlone[1]="a*b*c/9.0*x^9.0+a*b*c/6.0*x^6.0+a*b*c/5.0*x^5.0-a*b*c*2.0*x^2.0*1.0/2.0-a*b*c*50.0*x";
        Usage.EqnSolArrayMap4[1]="a*b*c/9.0*x^9.0+a*b*c/6.0*x^6.0+a*b*c/5.0*x^5.0-a*b*c*x^2.0-a*b*c*50.0*x";
        Usage.EqnSolOrder[1] = 1;
        ...
        Usage.EqnSolArrayMap3[2]="a*b*c/9.0*x^9.0+a*b*c/6.0*x^6.0+a*b*c/5.0*x^5.0-a*b*c*x^2.0-a*b*c*50.0*x";
        Usage.EqnSolArrayIntegrAlone[2]="a*b*c/9.0/10.0*x^10.0+a*b*c/6.0/7.0*x^7.0+a*b*c/5.0/6.0*x^6.0-a*b*c/3.0*x^3.0-a*b*c*50.0*x^2.0*1.0/2.0";
        Usage.EqnSolArrayMap4[2]="a*b*c/90.00000000000001*x^10.0+a*b*c/42.0*x^7.0+a*b*c/30.0*x^6.0-a*b*c/3.0*x^3.0-a*b*c*25.0*x^2.0";
        Usage.EqnSolOrder[2] = 2;
        ...
        Usage.EqnSolArrayMap3[3]="a*b*c/90.00000000000001*x^10.0+a*b*c/42.0*x^7.0+a*b*c/30.0*x^6.0-a*b*c/3.0*x^3.0-a*b*c*25.0*x^2.0";
        Usage.EqnSolArrayIntegrAlone[3]="a*b*c/90.00000000000001/11.0*x^11.0+a*b*c/42.0/8.0*x^8.0+a*b*c/30.0/7.0*x^7.0-a*b*c/3.0/4.0*x^4.0-a*b*c*25.0*1.0/3.0*x^3.0";
        Usage.EqnSolArrayMap4[3]="a*b*c/990.0000000000002*x^11.0+a*b*c/336.0*x^8.0+a*b*c/210.00000000000003*x^7.0-a*b*c/12.0*x^4.0-a*b*c*8.333333333333334*x^3.0";
        Usage.EqnSolOrder[3] = 3;
        ...
        Usage.EqnSolArrayMap3[4]="a*b*c/990.0000000000002*x^11.0+a*b*c/336.0*x^8.0+a*b*c/210.00000000000003*x^7.0-a*b*c/12.0*x^4.0-a*b*c*8.333333333333334*x^3.0";
        Usage.EqnSolArrayIntegrAlone[4]="a*b*c/990.0000000000002/12.0*x^12.0+a*b*c/336.0/9.0*x^9.0+a*b*c/210.00000000000003/8.0*x^8.0-a*b*c/12.0/5.0*x^5.0-a*b*c*8.333333333333334*1.0/4.0*x^4.0";
        Usage.EqnSolArrayMap4[4]="a*b*c/11880.000000000004*x^12.0+a*b*c/3024.0*x^9.0+a*b*c/1680.0000000000002*x^8.0-a*b*c/60.0*x^5.0-a*b*c*2.0833333333333335*x^4.0";
        Usage.EqnSolOrder[4] = 4;
       ...
       public static void TestCaseDiff50012() {
        ...
        Usage.EqnSolArrayIntegrAlone[1]="p/9.0*xyc1^9.0+p/6.0*xyc1^6.0+p/5.0*xyc1^5.0+p/2.0*xyc1^2.0+p*25.0*xyc1";
        ...
        Usage.EqnSolArrayIntegrAlone[2]="p/9.0/10.0*xyc1^10.0+p/6.0/7.0*xyc1^7.0+p/5.0/6.0*xyc1^6.0+p/2.0/3.0*xyc1^3.0+p*25.0*xyc1^2.0*1.0/2.0";
